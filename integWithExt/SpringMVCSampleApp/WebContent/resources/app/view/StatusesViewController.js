/*
 * File: app/view/StatusesViewController.js
 *
...
Ext.define('Login.view.StatusesViewController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.statuses',
    ...
    add: function(button, e, eOpts) {
        var formPanel = this.getReferences().form,
            ...
            newRecord = Ext.create('model.status');
    ...
    edit: function(button, e, eOpts) {
        ...
        // Set title
        formPanel.setTitle('Edit Status');
    ...
    remove: function(button, e, eOpts) {
        ...
        Ext.Msg.confirm('Confirm Delete', 'Are you sure you want to delete this status?', function(result) {

            // User confirmed yes
            if (result == 'yes') {

                var record = me.getViewModel().get('record'),
                    store = me.getStore('statuses');
