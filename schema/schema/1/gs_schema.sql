...
--------------------------------------------------------
  ...
  CREATE TABLE "ITA"."GS_CONTAINER" 
   (	"CONTAINER_ID" NUMBER(*,0), 
	"BKG_NUM" VARCHAR2(10 BYTE), 
	"GROSS_WEIGHT" NUMBER(2,0), 
	"NET_WEIGHT" NUMBER(2,0), 
	"UNIT" NUMBER(*,0) DEFAULT 0, 
	"CONTAINER_NUM" VARCHAR2(10 BYTE), 
	"CARGO_NATURE" VARCHAR2(2 BYTE), 
	"CONTAINER_TYPE" VARCHAR2(4 BYTE), 
	"CARGO_DESC" VARCHAR2(100 BYTE)
   ) SEGMENT CREATION IMMEDIATE 
  PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 NOCOMPRESS LOGGING
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  CREATE TABLE "ITA"."GS_BOOKING" 
   (	"BKG_NUM" VARCHAR2(10 BYTE), 
	...
	"IS_VALID_WEIGHT" NUMBER(*,0) DEFAULT 0, 
	"IS_APPROVED" NUMBER(*,0) DEFAULT 0, 
	"IS_GOOD_CUSTOMER" NUMBER(*,0) DEFAULT 0, 
	"CONSIGNEE" VARCHAR2(40 BYTE), 
	"SHIPPER" VARCHAR2(40 BYTE), 
	"FROM_CITY" VARCHAR2(3 BYTE), 
	"TO_CITY" VARCHAR2(40 BYTE)
   ) SEGMENT CREATION IMMEDIATE 
  PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 NOCOMPRESS LOGGING
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
