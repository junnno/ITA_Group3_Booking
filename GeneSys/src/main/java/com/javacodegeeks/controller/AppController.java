...
//		return "index2";
	...
	@RequestMapping(value = { "/senchaPage"}, method = RequestMethod.GET)
	public String listEmployees() {
		return "index";
	}

	@ResponseBody
	@RequestMapping(value = { "/getSencha" }, method = RequestMethod.GET)
	public List<Employee> getAllLoggedUsers(ModelMap model) {
